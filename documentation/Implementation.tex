...
\begin{tikzpicture}[node distance = 5mm,align=center]
    ...
    \node [decision, below=of derive, inner sep=0pt] (useRandomSeed) {random\\ seed\\ by clock?};
    \node [block, right of=useRandomSeed, node distance=3cm, text width=3.5em,] (initRandomSeed) {set random seed by clock};
...
\inoutentry{m,n}{integer}{}{}{}{}
\inoutentry{mn}{integer}{}{}{}{}
\inoutentry{infiltKern}{8-byte real}{\mn}{}{}{infiltration probability}
\inoutentry{storeKern}{8-byte real}{\mn}{}{}{storage capacity}
\inoutentry{topog}{8-byte real}{\mn}{}{}{topography}
\inoutentry{precip}{integer}{\mn}{}{}{rainfall}
\inoutentry{store}{integer}{\mn}{}{}{}
\inoutentry{newflowdirns}{integer}{\mn}{}{}{flow directions}
}{
\inoutentry{outflow}{integer}{}{}{}{cumulative outflow (leaving model domain)}
\inoutentry{store}{integer}{\mn}{}{}{water infiltrated}
\inoutentry{newflowdirns}{integer}{\mn}{}{}{new flow directions}
\inoutentry{discharge}{integer}{\mn}{}{}{cumulative amount of overland flow}
}
...
\inoutentry{te}{8-byte real}{}{t_e}{T}{length of a time step in evap calcs \annote[nanu]{(dry period of the year)}{is this right?}}
\inoutentry{Emax}{8-byte real}{}{T_{max}}{L\ T^{-1}}{maximum plant transpiration}
}{
\inoutentry{store}{integer}{:,:}{}{}{}
\inoutentry{eTActual}{integer}{:,:}{}{}{}
\inoutentry{bareE}{integer}{:,:}{}{}{}
...
This subroutine implements the simple algorithm to change vegetation/bare soil status and update biomass

\inout{
\inoutentry{m,n}{integer}{}{}{}{}
\inoutentry{etPersists}{integer}{}{T_c}{L\,T^{-1}}{annual transpiration rate over which plants start to grow (transpiration threshold for carbon assimilation)}
\inoutentry{vegmax}{ingeger}{}{b_{max}}{}{maximum biomass}
\inoutentry{isGrow}{integer}{}{}{}{}
\inoutentry{useEmerge}{logical}{}{}{}{flag denotes whether to use random collonisation pc or storage based storEmerge}
\inoutentry{storEmerge}{integer}{}{w_{c}}{L}{water storage threshold triggering plant emergence at bare sites}
\inoutentry{veg}{integer}{\mn}{}{}{}
\inoutentry{store}{integer}{\mn}{}{}{}
\inoutentry{actualET}{integer}{\mn}{T_a}{L\,T^{-1}}{the spatial distribution of actual evapotranspiration}
}{
\inoutentry{veg}{integer}{\mn}{}{}{}
\inoutentry{store}{integer}{\mn}{}{}{}
...
Note: there is no variable for $\Delta \tilde{b}$, the normalized vegetation growth delta. It is simply set to \annote[nanu]{$1$.}{1 is not consistend with the following text! And maybe we should make this an input variable. }
\[
...
nondimensional threshold for plant emergence:
\[
\tilde{w}_c = \frac{w_c}{\Delta x}
\]
